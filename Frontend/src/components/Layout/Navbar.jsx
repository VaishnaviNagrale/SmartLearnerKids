  ...
  return (
    <div className="relative w-full bg-orange-200">
      ...
      src={image}
        ...
        <div className="hidden lg:block">
        <img
  className="relative z-10 inline-block h-10 w-10 rounded-lg ring-2 ring-orange-800"
...
/>
        ...
        {isMenuOpen && (
          <div className="absolute inset-x-0 top-0 z-50 origin-top-right transform p-2 transition lg:hidden">
            <div className="divide-y-2 divide-gray-50 rounded-lg bg-orange-200 shadow-lg ring-1 ring-black ring-opacity-5">
